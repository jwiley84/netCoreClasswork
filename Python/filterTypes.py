...
lazyProgram = [sI, mI, bI, eI, spI, sS, mS, bS, eS, aL, mL, lL, eL, spL]

for item in lazyProgram:
    if (type(item) is int):
        if (item >= 100):
...
print "That's a big number!" If the integer is less 
than 100, print "That's a small number"
...
print "Big list!" If the list has fewer than 10 values print 
"Short list."
'''